...
const mapStateToProps = (state) => {
  const { windSensor1, rainSensor1, floodSensor1, snowSensor1, windSensorAddress } = state.wifi;
  return {
    windSensor1, 
    rainSensor1, 
    floodSensor1, 
...
const mapDispatchToProps = (dispatch) => ({
    ...
    selectSensor : (windSensor, rainSensor, floodSensor, snowSensor, windAddress) => {
      dispatch(wifiActions.selectSensor(windSensor, rainSensor, floodSensor, snowSensor, windAddress))
    },
    getSensors : () => {
      dispatch(wifiActions.getSensors())
    },
    getWindAddress : () => {
      dispatch(wifiActions.getWindAddress())
    },
  })

const connectedWifi = connect(mapStateToProps, mapDispatchToProps)(withStyles(styles, { withTheme: true })(Wifi));
